...
// Images Directory
imagesDir = full_path + "editor/icons/";

// CSS Directory
cssDir = full_path + "editor/styles/";

// Popups Directory
popupsDir = full_path + "editor/popups/";
...
//Name              buttonID                 buttonTitle           buttonImage                            buttonImageRollover
  ...
  "paste":          ['Paste',                'Paste',              imagesDir + 'paste.gif',              imagesDir + 'paste_on.gif'],
	...
	"viewText":       ['ViewText',             'ViewHTML',           imagesDir + 'view_text.gif',          imagesDir + 'view_text_on.gif'],
  ...
  for (var j = 0; j <= buttonName2.length;) {
    if (buttonName2[j]) {
		...
		if (buttonName2[j] == "seperator") {
			...
			toolbar2 += '<span id="textMode' + n + '"><img src="' +imagesDir+ 'view_text.gif" border=0 unselectable="on" title="viewHTML"          id="ViewText"       class="wysiwygButton" onClick="formatText(this.id,\'' + n + '\');" onmouseover="if(className==\'button\'){className=\'buttonOver\'}; this.src=\'' +imagesDir+ 'view_text_on.gif\';"    onmouseout="if(className==\'buttonOver\'){className=\'button\'}; this.src=\'' +imagesDir+ 'view_text.gif\';" unselectable="on"  width="20" height="20"></span>';
			toolbar2 += '</td>';
		}
		else {
